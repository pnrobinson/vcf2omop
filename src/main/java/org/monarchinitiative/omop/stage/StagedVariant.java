...
public class StagedVariant {
    ...
    public StagedVariant(int omopId, int chrom, int pos, String ref, String alt, Assembly assembly) {
        this.omopId = omopId;
        this.chrom = chrom;
        this.pos = pos;
        this.ref = ref;
    ...
    public static StagedVariant fromLine(String line) {
        ...
        return new StagedVariant(omopId, chrom, pos,  ref,  alt,  assembly);
    }
